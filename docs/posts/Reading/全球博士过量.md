...
## 1. How many PhDs does the world need? Doctoral graduates vastly outnumber jobs in academia
...
## 6. 🛣 三、出路选择：局内搏生存，局外找机会

### 6.1. ✅ 方案 A：局内破局（如果你打算长期留下）

* 慢慢积累自己的人脉、位置、影响力；
* 等自己有资格参与资源分配时，尝试推动更合理的机制（比如项目开放、人才推荐机制等）。

### 6.2. ✅ 方案 B：局内打基础，局外找出口（推荐多数人）
